            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <tr>
                            <td style="text-align: right; vertical-align: middle;">{{ $departamento->nome }}</td>
                            <td>
                                <a href="{{ url('/home/departamento/'.$departamento->id) }}">
                                    <div class="btn btn-primary">Alterar</div>
                                </a>
                                <a href="{{ url('/home/departamento/'.$departamento->id.'/del') }}">
                    ...
                    <div class="row">
                    <div class="col-md-12">
                    <a href="{{ url('/home/departamento/novo') }}">
